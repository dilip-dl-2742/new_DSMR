...
[5, "Document DB Primary Instance", db2_cpu], [6, "Document DB Replica Instance", db1_cpu],
...
body = """
<h4 style="color:red"><b>NOTE:</b></h4> <p><b>Please Do Not Reply to this Email. If you have any queries please reply back to :</b></p><a href='mailto:DilipKumar.Doddi@americold.com' target='blank'>DilipKumar.Doddi@americold.com</a>
<br><br>
...
"""0 10 * * * sh /PythonCode/PYCRON.sh

PYCRON.sh --> 

$date
python3 /PythonCode/main_metrics_code.py > /PythonCode/DSMRlogs.txt
"""
